...
import 'package:campus_vote/core/api/generated/api.pb.dart' as $0;
...
class CampusVoteClient extends $grpc.Client {
  ...
  static final _$getVoterByStudentId =
      $grpc.ClientMethod<$0.StudentId, $0.Voter>(
    '/CampusVote/GetVoterByStudentId',
    ($0.StudentId value) => value.writeToBuffer(),
    ($core.List<$core.int> value) => $0.Voter.fromBuffer(value),
  );
  static final _$setVoterAsVoted =
      $grpc.ClientMethod<$0.StudentId, $0.StatusCode>(
    '/CampusVote/SetVoterAsVoted',
    ($0.StudentId value) => value.writeToBuffer(),
    ($core.List<$core.int> value) => $0.StatusCode.fromBuffer(value),
  );
  static final _$checkVoterStatus =
      $grpc.ClientMethod<$0.StudentId, $0.StatusCode>(
    '/CampusVote/CheckVoterStatus',
    ($0.StudentId value) => value.writeToBuffer(),
    ($core.List<$core.int> value) => $0.StatusCode.fromBuffer(value),
  );
  static final _$getElectionStats =
      $grpc.ClientMethod<$0.Void, $0.ElectionStats>(
  ...
  $grpc.ResponseFuture<$0.StatusCode> createVoter($0.Voter request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$createVoter, request, options: options);
  }

  $grpc.ResponseFuture<$0.Voter> getVoterByStudentId($0.StudentId request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getVoterByStudentId, request, options: options);
  }

  $grpc.ResponseFuture<$0.StatusCode> setVoterAsVoted($0.StudentId request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$setVoterAsVoted, request, options: options);
  }

  $grpc.ResponseFuture<$0.StatusCode> checkVoterStatus($0.StudentId request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$checkVoterStatus, request, options: options);
  }

  $grpc.ResponseFuture<$0.ElectionStats> getElectionStats($0.Void request,
      {$grpc.CallOptions? options}) {
...
abstract class CampusVoteServiceBase extends $grpc.Service {
  ...
  CampusVoteServiceBase() {
    $addMethod(
      $grpc.ServiceMethod<$0.Voter, $0.StatusCode>(
        'CreateVoter',
        createVoter_Pre,
        false,
        false,
    ...
    $addMethod(
      $grpc.ServiceMethod<$0.StudentId, $0.Voter>(
        'GetVoterByStudentId',
    ...
    $addMethod(
      $grpc.ServiceMethod<$0.StudentId, $0.StatusCode>(
        'SetVoterAsVoted',
        setVoterAsVoted_Pre,
        false,
        false,
    ...
    $addMethod(
      $grpc.ServiceMethod<$0.Void, $0.ElectionStats>(
        'GetElectionStats',
  ...
  $async.Future<$0.StatusCode> createVoter_Pre(
      $grpc.ServiceCall call, $async.Future<$0.Voter> request) async {
    return createVoter(call, await request);
  }

  $async.Future<$0.Voter> getVoterByStudentId_Pre(
      $grpc.ServiceCall call, $async.Future<$0.StudentId> request) async {
    return getVoterByStudentId(call, await request);
  }

  $async.Future<$0.StatusCode> setVoterAsVoted_Pre(
      $grpc.ServiceCall call, $async.Future<$0.StudentId> request) async {
    return setVoterAsVoted(call, await request);
  }

  $async.Future<$0.StatusCode> checkVoterStatus_Pre(
      $grpc.ServiceCall call, $async.Future<$0.StudentId> request) async {
    return checkVoterStatus(call, await request);
  }

  $async.Future<$0.ElectionStats> getElectionStats_Pre(
      $grpc.ServiceCall call, $async.Future<$0.Void> request) async {
    return getElectionStats(call, await request);
  }

  $async.Future<$0.StatusCode> createVoter(
      $grpc.ServiceCall call, $0.Voter request);
  $async.Future<$0.Voter> getVoterByStudentId(
      $grpc.ServiceCall call, $0.StudentId request);
  $async.Future<$0.StatusCode> setVoterAsVoted(
      $grpc.ServiceCall call, $0.StudentId request);
  $async.Future<$0.StatusCode> checkVoterStatus(
      $grpc.ServiceCall call, $0.StudentId request);
  $async.Future<$0.ElectionStats> getElectionStats(
