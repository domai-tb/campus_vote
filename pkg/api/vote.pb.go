...
type Voter struct {
	...
	Shk       string     `protobuf:"bytes,6,opt,name=shk,proto3" json:"shk,omitempty"`
	// 0 => not voted
	// 1 => got ballot
	// 2 => voted
...
type BallotBoxStats struct {
	...
	TotalVoters int64             `protobuf:"varint,3,opt,name=totalVoters,proto3" json:"totalVoters,omitempty"`
	VotesPerDay []*VotingDayStats `protobuf:"bytes,4,rep,name=votesPerDay,proto3" json:"votesPerDay,omitempty"`
}
...
func (x *BallotBoxStats) GetTotalVoters() int64 {
	if x != nil {
...
type ElectionStats struct {
	...
	TotalVotes   int64             `protobuf:"varint,2,opt,name=totalVotes,proto3" json:"totalVotes,omitempty"`
	TotalVoters  int64             `protobuf:"varint,3,opt,name=totalVoters,proto3" json:"totalVoters,omitempty"`
	BallotBoxes  []*BallotBoxStats `protobuf:"bytes,4,rep,name=ballotBoxes,proto3" json:"ballotBoxes,omitempty"`
}
...
func (x *ElectionStats) GetTotalVoters() int64 {
	if x != nil {
		return x.TotalVoters
	}
	return 0
...
var file_vote_proto_rawDesc = []byte{
	...
	0x52, 0x03, 0x6e, 0x75, 0x6d, 0x22, 0xda, 0x01, 0x0a, 0x05, 0x56, 0x6f, 0x74, 0x65, 0x72, 0x12,
	...
	0x66, 0x61, 0x63, 0x75, 0x6c, 0x69, 0x74, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x73, 0x68, 0x6b, 0x18,
	0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x73, 0x68, 0x6b, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x22, 0x7c, 0x0a, 0x0e, 0x56, 0x6f, 0x74, 0x69, 0x6e, 0x67, 0x44, 0x61, 0x79, 0x53,
	...
	0x22, 0xa4, 0x01, 0x0a, 0x0e, 0x42, 0x61, 0x6c, 0x6c, 0x6f, 0x74, 0x42, 0x6f, 0x78, 0x53, 0x74,
	...
	,
...
var file_vote_proto_depIdxs = []int32{
	...
	5, // 6: CampusVote.Vote.RegisterVotingStep:input_type -> CampusVote.VoteReq
	...
	7, // 11: CampusVote.Vote.RegisterVotingStep:output_type -> CampusVote.StatusCode
