...
func (c *voteClient) SetVoterAsVoted(ctx context.Context, in *StudentId, opts ...grpc.CallOption) (*StatusCode, error) {
	out := new(StatusCode)
	err := c.cc.Invoke(ctx, "/CampusVote.Vote/SetVoterAsVoted", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedVoteServer) SetVoterAsVoted(context.Context, *StudentId) (*StatusCode, error) {
...
func _Vote_SetVoterAsVoted_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StudentId)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VoteServer).SetVoterAsVoted(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/CampusVote.Vote/SetVoterAsVoted",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VoteServer).SetVoterAsVoted(ctx, req.(*StudentId))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Vote_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Vote_SetVoterAsVoted_Handler,
		},
		{
